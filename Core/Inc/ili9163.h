 ...
 *
 * */
#define DISP_CS_Pin GPIO_PIN_7 //this place will be changed acc to pin configuration
#define DISP_CS_Port GPIOE//this place will be changed acc to pin configuration

#define DISP_DC_Pin GPIO_PIN_8//this place will be changed acc to pin configuration
#define DISP_DC_Port GPIOE//this place will be changed acc to pin configuration

#define DISP_RST_Pin GPIO_PIN_9//this place will be changed acc to pin configuration
#define DISP_RST_Port GPIOE//this place will be changed acc to pin configuration
