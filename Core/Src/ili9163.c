...
void ILI9163_fillCircle(uint8_t centerX, uint8_t centerY, uint8_t radius,
		uint16_t color) {
...
void ILI9163_drawCircle(uint8_t centerX, uint8_t centerY, uint8_t radius,
		uint16_t color) { // From the Adafruit GFX library
...
void ILI9163_drawStringF(uint8_t x, uint8_t y, FontDef font, uint16_t color,
		char *szFormat, ...) {
	char szBuffer[64];
	va_list pArgs;
